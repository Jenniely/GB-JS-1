...
function startGame() {
    ...
    obstacle_timer = setInterval(createObstacle, 7000);
}
...
function move() {
    ...
    } else if (hitObstacle(new_unit) && new_unit !== undefined) {
        finishTheGame();
    } else if (!isSnakeUnit(new_unit) && new_unit !== undefined) {
...
function finishTheGame() {
    ...
    var scoreBoard = document.getElementsByClassName('score-board')[0];
    scoreBoard.innerHTML = 'Вы проиграли! Ваш результат: ' + score.toString();
}
